...
class App {
    ...
    public static void main(String[] args) throws Exception {
        // BEGIN
        String sourceFilePath1 = "src/main/resources/file1.txt";
        String sourceFilePath2 = "src/main/resources/file2.txt";
        String destinationFilePath = "src/main/resources/merged_result.txt"; // Имя итогового файла

        unionFiles(sourceFilePath1, sourceFilePath2, destinationFilePath)
